        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 min-h-[70vh]">
            <div className="card md:col-span-1 flex flex-col">
                <div className="cardHeader">
                    ...
                    <p className="text-sm text-[var(--muted-foreground)]">Your active chats with workers.</p>
                </div>
                <div className="cardContent flex-grow overflow-auto">
                    <div className="space-y-2">
                        <div className="group active flex items-center gap-3 p-2 rounded-lg bg-[var(--accent)] cursor-pointer">
                            ...
                            <div>
                                <p className="font-semibold group-[.active]:text-white">Max R.</p>
                                <p className="text-xs text-[var(--muted-foreground)] group-[.active]:text-white">About: Assemble IKEA Bookshelf</p>
                            </div>
                        </div>
                        <div className="flex items-center gap-3 p-2 rounded-lg hover:bg-[var(--secondary)] cursor-pointer">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-[var(--muted-foreground)]">About: Mount 65" TV on wall</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="card md:col-span-2 flex flex-col">
                <div className="border-b border-[var(--border)] cardHeader">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <div className="cardTitle text-2xl tracking-tight">Max R.</div>
                            <p className="text-sm text-[var(--muted-foreground)]">Regarding "Assemble IKEA Bookshelf"</p>
                        </div>
                    </div>
                </div>
                <div className="flex-grow overflow-auto p-6 space-y-4">
                    <div className="flex justify-end">
                        <div className="bg-[var(--primary)] text-[var(--primary-foreground)] p-3 rounded-lg max-w-xs">
                            <p className="text-sm">Hi Max, I see you made an offer on the bookshelf job. Are you available tomorrow?</p>
                        </div>
                    </div>
                    <div className="flex justify-start">
                        <div className="bg-[var(--secondary)] p-3 rounded-lg max-w-xs">
                            <p className="text-sm">Yes, I am! I can be there around 2 PM. Does that work for you?</p>
                        </div>
                    </div>
                    <div className="flex justify-end">
                        <div className="bg-[var(--primary)] text-[var(--primary-foreground)] p-3 rounded-lg max-w-xs">
